...
export const mostWatchedLead: Story = fromTour('independence-square');
...
export const forYouLead: Story = {
  ...fromTour('labadi-beach'),
  image: 'https://res.cloudinary.com/ynvljxj8/image/upload/f_auto,q_auto/v1786113845/tour-ghana/kempinski-hotel-accra.jpg',
