...
exports.regionBySlug = exports.categoryBySlug = exports.regions = exports.categories = exports.tourBySlug = exports.tours = void 0;
exports.slugify = slugify;
exports.tourHref = tourHref;
const images_1 = require("./images");
exports.tours = [
    {
        slug: 'cape-coast-castle',
        name: 'Cape Coast Castle',
        headline: 'Cape Coast Castle: walking the stone corridors where Ghana’s Atlantic story is told',
        region: 'Central Region',
        category: 'Forts & Castles',
        summary: 'A UNESCO World Heritage site on the Gulf of Guinea, Cape Coast Castle is the most visited monument on Ghana’s coast and the anchor of every heritage itinerary.',
    ...
    },
    {
        slug: 'elmina-castle',
        name: 'Elmina Castle',
        headline: 'Elmina Castle, built in 1482, is the oldest European building south of the Sahara',
        region: 'Central Region',
        category: 'Forts & Castles',
        summary: 'Portuguese-built, Dutch-held and finally British, Elmina Castle sits above a working lagoon harbour thirteen kilometres from Cape Coast.',
    ...
    },
    {
        ...
        headline: 'Above the rainforest: the Kakum canopy walkway is still Ghana’s most thrilling half hour',
        region: 'Central Region',
        category: 'Parks & Wildlife',
        summary: 'Seven rope bridges strung between giant emergent trees, forty metres above the floor of a protected tropical rainforest.',
        image: images_1.images.kakum,
        gallery: [images_1.images.kakum, images_1.images.wli],
    ...
    },
    {
        ...
        category: 'Parks & Wildlife',
        summary: 'Ghana’s largest wildlife reserve, where guided walking safaris bring visitors within metres of elephants at the waterholes.',
    ...
    },
    {
        ...
        summary: 'A living village built entirely on stilts over Lake Tadane, reached by dugout canoe through the Amansuri wetlands.',
        ...
        gallery: ['https://res.cloudinary.com/ynvljxj8/image/upload/f_auto,q_auto,w_2400,c_limit/v1786113778/tour-ghana/nzulezu-stilt-village.jpg', images_1.images.wli],
    ...
    },
    {
        ...
        region: 'Volta Region',
        category: 'Parks & Wildlife',
        summary: 'A two-stage waterfall inside the Agumatsa Wildlife Sanctuary, with an easy lower trail and a demanding climb to the upper falls.',
        image: images_1.images.wli,
        gallery: [images_1.images.wli, images_1.images.kakum],
    ...
    },
    {
        ...
        category: 'Parks & Wildlife',
        summary: 'Sixty-four hectares of colonial-era gardens on the Akuapem ridge, forty minutes above the capital.',
        image: images_1.images.aburi,
        gallery: [images_1.images.aburi, images_1.images.wli],
    ...
    },
    {
        ...
        category: 'Culture & Heritage',
        summary: 'A sacred pond on the Burkina Faso border where the crocodiles are considered the reincarnated souls of the townspeople.',
        ...
        gallery: ['https://res.cloudinary.com/ynvljxj8/image/upload/f_auto,q_auto,w_2400,c_limit/v1786113785/tour-ghana/paga-crocodile-pond.jpg', images_1.images.mole],
    ...
    },
    {
        ...
        summary: 'Accra’s busiest and most sociable stretch of sand, run by the La traditional council and best visited at the weekend.',
        image: '/labadi-beach-02.jpg',
        imageCredit: 'Photos: Ghassan Mroue and Cca Raheem / Wikimedia Commons (CC BY-SA 3.0 / CC BY 4.0)',
        gallery: [
            '/labadi-beach-02.jpg',
            '/labadi-beach-01.jpg',
            images_1.images.labadi
        ],
    ...
    },
    {
        ...
        category: 'Culture & Heritage',
        summary: 'The historic home of Asante kente weaving, twenty minutes from Kumasi, where visitors can sit at a loom themselves.',
    ...
    },
    {
        ...
        headline: 'Manhyia Palace Museum tells the Asante story in the kingdom’s own words',
        region: 'Ashanti Region',
        category: 'Culture & Heritage',
        summary: 'The former residence of the Asantehene in Kumasi, now a museum of the kingdom’s regalia, history and continuing authority.',
    ...
    },
    {
        ...
        region: 'Greater Accra',
        category: 'Culture & Heritage',
        summary: 'Black Star Square, the Independence Arch and the Kwame Nkrumah Memorial Park make up the ceremonial heart of the capital.',
        ...
        gallery: ['https://res.cloudinary.com/ynvljxj8/image/upload/f_auto,q_auto,w_2400,c_limit/v1786114227/tour-ghana/independence-arch-sunset.jpg', images_1.images.labadi],
    ...
    },
    {
        ...
        headline: 'Homowo season brings the drums back to Accra, and the whole city eats kpokpoi',
        region: 'Greater Accra',
        category: 'Festivals',
        summary: 'The Ga harvest festival that "hoots at hunger", marked across Accra with a ban on drumming, then a month of processions.',
    ...
    },
    {
        slug: 'damba-festival',
        name: 'Damba Festival',
        headline: 'Damba in Tamale is a horse festival, a durbar and an all-night party',
        region: 'Northern Region',
        category: 'Festivals',
        summary: 'The great festival of the Dagbon, Mamprusi and Gonja kingdoms, marked with drumming, dancing and a mounted chiefs’ durbar.',
    ...
    },
    {
        ...
        region: 'Central Region',
        category: 'Coast & Beaches',
        summary: 'Hundreds of hand-painted canoes packed into the Benya Lagoon beneath the castle walls, at their busiest just after dawn.',
    ...
    },
    {
        ...
        headline: 'A first-timer’s guide to eating jollof, waakye and banku in Accra',
        region: 'Greater Accra',
        category: 'Food & Dining',
        summary: 'Chop bars, waakye stands and rooftop kitchens: how to eat well in the capital, from breakfast to late night.',
        image: images_1.images.jollof,
        gallery: [images_1.images.jollof, images_1.images.labadi],
    ...
    },
    {
        ...
        region: 'Central Region',
        category: 'Festivals',
        summary: 'Each May, two rival Asafo companies in Winneba race unarmed into the bush to catch a live bushbuck for the Effutu god Otu, then parade it home to a beach town in full carnival mood.',
    ...
    },
    {
        ...
        region: 'Eastern Region',
        category: 'Festivals',
        summary: 'A week of purification and thanksgiving in the hill town of Akropong, Odwira cleans the ancestral stools of the Akuapem state and formally releases the new yam crop for eating.',
    ...
    },
    {
        ...
        region: 'Volta Region',
        category: 'Festivals',
        summary: 'Anloga’s biggest day of the year re-tells the seventeenth-century escape of the Anlo-Ewe from the walled city of Notsie, with a coastal clean-up, peace rites and a grand durbar.',
    ...
    },
    {
        ...
        region: 'Western Region',
        category: 'Festivals',
        summary: 'A rolling calendar of harvest thanksgiving festivals along the western coast, Kundum passes through Ahanta and Nzema towns from August into November, each keeping its own date.',
    ...
    },
    {
        ...
        region: 'Central Region',
        category: 'Festivals',
        summary: 'The Oguaa state’s biggest festival closes out the year with Asafo companies parading from Kotokuraba Market to the chief’s palace, marking a historic purification that ended a plague.',
    ...
    },
    {
        ...
        region: 'Central Region',
        category: 'Festivals',
        summary: 'Every July, the chief of Elmina casts a net into the Benya Lagoon to lift a season-long fishing ban, opening the year’s fishing season with a royal procession and durbar.',
    ...
    },
    {
        ...
        region: 'Ashanti Region',
        category: 'Festivals',
        summary: 'Every sixth Sunday, the Asantehene, chiefs and elders assemble at Manhyia Palace to honour Asante ancestors and display the Golden Stool — the closest most visitors get to the working court of the Asante kingdom.',
    ...
    },
    {
        ...
        category: 'Festivals',
        summary: 'Deep in the Upper West, Lawra’s Dagara community spends four days reuniting scattered families, parading as hunters and elephants, and competing in the region’s signature Kobine dance.',
    ...
    },
    {
        ...
        region: 'Central Region',
        category: 'Festivals',
        summary: 'Every odd-numbered year, the Pan-African Historical Theatre Festival brings performers and visitors from across Africa and its diaspora to Cape Coast and Elmina, closing with a candlelight vigil at the Door of No Return.',
    ...
    },
    {
        ...
        region: 'Greater Accra',
        category: 'Festivals',
        summary: 'For five days each August, Accra’s historic Jamestown fills with murals, performance and film as the Chale Wote Street Art Festival turns its lanes and lighthouse into Ghana’s biggest contemporary arts event.',
    ...
    },
    {
        ...
        summary: 'A five-star landmark on Gamel Abdul Nasser Avenue, with a rooftop pool, spa and some of the largest rooms in the capital.',
    ...
    },
    {
        ...
        region: 'Greater Accra',
        category: 'Where To Stay',
        summary: 'A beachfront hotel with direct access to its own stretch of sand next to Labadi Beach, popular for weekend pool days as well as overnight stays.',
    ...
    },
    {
        ...
        region: 'Greater Accra',
        category: 'Where To Stay',
        summary: 'A small boutique hotel in Osu built around a plunge pool and courtyard, walking distance from Oxford Street’s restaurants and shops.',
    ...
    },
    {
        ...
        region: 'Central Region',
        category: 'Where To Stay',
        summary: 'A beachfront resort just outside Elmina, within easy reach of Elmina Castle, Cape Coast Castle and Kakum National Park.',
    ...
    },
    {
        ...
        region: 'Central Region',
        category: 'Where To Stay',
        summary: 'A low-rise beach resort in the fishing town of Anomabo, a quieter alternative to staying directly in Cape Coast.',
    ...
    },
    {
        ...
        region: 'Western Region',
        category: 'Where To Stay',
        summary: 'A beachfront resort in Busua, the Western Region’s best-known surf town, with board rental and lessons run out of the village itself.',
        image: images_1.images.hotel,
        gallery: [images_1.images.nzulezu, images_1.images.labadi],
    ...
    },
    {
        ...
        region: 'Ashanti Region',
        category: 'Where To Stay',
        summary: 'A hilltop hotel overlooking Kumasi, close to Manhyia Palace and Kejetia Market, with conference space that makes it a regular choice for business travel.',
        image: images_1.images.kente,
        gallery: [images_1.images.hotel, images_1.images.chief],
    ...
    },
    {
        ...
        region: 'Ashanti Region',
        category: 'Where To Stay',
        summary: 'A mid-range hotel in central Kumasi, within walking distance of Kejetia Market and a short ride from Manhyia Palace.',
        image: images_1.images.hotel,
        gallery: [images_1.images.kente, images_1.images.chief],
    ...
    },
    {
        ...
        region: 'Eastern Region',
        category: 'Where To Stay',
        summary: 'A resort on the banks of the Volta River just above the Akosombo Dam, with pool decks and gardens running down to the water.',
        image: images_1.images.aburi,
        gallery: [images_1.images.hotel, images_1.images.wli],
    ...
    },
    {
        ...
        region: 'Volta Region',
        category: 'Where To Stay',
        summary: 'A hillside hotel in Ho, the most practical overnight base for reaching Wli Falls and the Volta Region’s hiking trails.',
        image: images_1.images.wli,
        gallery: [images_1.images.hotel, images_1.images.aburi],
    ...
    },
    {
        ...
        region: 'Savannah Region',
        category: 'Where To Stay',
        summary: 'A tented lodge inside Mole National Park itself, close enough to the waterhole to watch elephants without leaving the grounds.',
        image: images_1.images.mole,
        gallery: [images_1.images.hotel, images_1.images.paga],
    ...
    },
    {
        ...
        region: 'Northern Region',
        category: 'Where To Stay',
        summary: 'A mid-range hotel in central Tamale, the usual staging point for trips to Mole National Park and Northern Region festivals.',
        image: images_1.images.hotel,
        gallery: [images_1.images.mole, images_1.images.paga],
    ...
    },
    {
        ...
        region: 'Upper East Region',
        category: 'Where To Stay',
        summary: 'A straightforward hotel in Bolgatanga, the usual overnight base for visiting Paga’s crocodile ponds and the Upper East’s craft villages.',
        image: images_1.images.paga,
        gallery: [images_1.images.hotel, images_1.images.mole],
    ...
    },
    {
        ...
        region: 'Upper West Region',
        category: 'Where To Stay',
        summary: 'A modest hotel in Wa, the Upper West’s regional capital, used mainly as a stop for travellers heading to Lawra and the Kobine festival.',
        image: images_1.images.hotel,
        gallery: [images_1.images.paga, images_1.images.chief],
    ...
    },
    {
        ...
        region: 'Eastern Region',
        category: 'Where To Stay',
        summary: 'A hillside resort in Nkwatia on the Kwahu Plateau, built around twin outdoor pools, rooftop cabanas and modern rooms, with views across the escarpment.',
...
exports.tourBySlug = exports.tours.reduce((acc, tour) => ({ ...acc, [tour.slug]: tour }), {});
...
function tourHref(tour) {
    if (tour.category === 'Where To Stay')
        return `/where-to-stay/${tour.slug}`;
    if (tour.category === 'Festivals')
        return `/category/festivals/${tour.slug}`;
    return `/tours/${tour.slug}`;
}
function groupBy(field) {
    const names = Array.from(new Set(exports.tours.map((t) => t[field])));
    return names.map((name) => ({
        slug: slugify(name),
        name,
        tours: exports.tours.filter((t) => t[field] === name),
    }));
}
exports.categories = groupBy('category');
exports.regions = groupBy('region');
exports.categoryBySlug = Object.fromEntries(exports.categories.map((c) => [c.slug, c]));
exports.regionBySlug = Object.fromEntries(exports.regions.map((r) => [r.slug, r]));
