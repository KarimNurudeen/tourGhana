  ...
  return (
    <div
      ...
      <div
        ...
        className="w-full max-w-2xl border-4 border-flagRed bg-flagGreen/25 backdrop-blur-md">
        <div className="flex items-center gap-3 border-b border-white/15 px-5 py-4">
          ...
          <input
            ...
            className="w-full bg-transparent text-[17px] text-white placeholder:text-neutral-300 focus:outline-none"
          />
          <button
            type="button"
            onClick={onClose}
            aria-label="Close search"
            className="shrink-0 text-white transition hover:text-flagGold">
        ...
        <div className="max-h-[60vh] overflow-y-auto">
          {trimmed === '' && (
            <p className="px-5 py-8 text-center text-[14px] text-neutral-200">
              ...
              {results.map((tour) => (
                <li key={tour.slug}>
                  <Link
                    ...
                    onClick={onClose}
                    className="flex items-center gap-4 px-5 py-3 transition hover:bg-black/20">
