...
export interface ApiCategoryColumnCategoryColumn
  ...
  attributes: {
    columnId: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    href: Schema.Attribute.String & Schema.Attribute.Required;
    items: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    lead: Schema.Attribute.Relation<'manyToOne', 'api::tour.tour'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-column.category-column'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    forYouGrid: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    forYouLead: Schema.Attribute.Relation<'oneToOne', 'api::tour.tour'>;
    forYouLeadTitle: Schema.Attribute.String;
    heroLead: Schema.Attribute.Relation<'oneToOne', 'api::tour.tour'>;
    heroMore: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    historyFeature: Schema.Attribute.Relation<'oneToOne', 'api::tour.tour'>;
    historyFeatureTitle: Schema.Attribute.String;
    latestUpdates: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mostRead: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    photography: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    photoStrip: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    publishedAt: Schema.Attribute.DateTime;
    sidebarFeature: Schema.Attribute.Relation<'oneToOne', 'api::tour.tour'>;
    sidebarStories: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    tickerLinks: Schema.Attribute.Component<'shared.link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiQuizQuestionQuizQuestion
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Relation<'manyToOne', 'api::tour.tour'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTopicBlockTopicBlock extends Struct.CollectionTypeSchema {
  collectionName: 'topic-blocks';
  info: {
    description: '';
  ...
  attributes: {
    blockId: Schema.Attribute.UID<'topic'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lead: Schema.Attribute.Relation<'manyToOne', 'api::tour.tour'>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::topic-block.topic-block'
    > &
      Schema.Attribute.Private;
    more: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coordinates: Schema.Attribute.Component<'tour.coordinates', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    festivalTiming: Schema.Attribute.Component<'tour.festival-timing', false>;
    gallery: Schema.Attribute.Media<'images', true>;
    gettingThere: Schema.Attribute.JSON;
    ...
    nearby: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    overview: Schema.Attribute.JSON;
    photoCategories: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
