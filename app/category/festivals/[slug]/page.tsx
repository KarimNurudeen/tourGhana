...
import { FestivalPhotoBrowser } from '@/components/FestivalPhotoBrowser';
    ...
    <main id="main" className="w-full bg-white">
      <div className="mx-auto max-w-page px-4 pt-6">
        <nav
          ...
          <Link href="/category/festivals" className="hover:text-flagGreen">
            Festivals
          </Link>
          <ChevronRightIcon className="h-3.5 w-3.5" />
        ...
        <article className="mt-6 border-t border-rule pt-6">
          ...
          <FestivalPhotoBrowser images={heroImages} name={tour.name} />
          {tour.imageCredit && (
